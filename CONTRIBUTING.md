## Contributing to Knex Schema Reader

♥ [Knex Schema Reader](https://github.com/mattjcowan/knex-schema-reader) and want to get involved? Thanks!
...
The [issue tracker](https://github.com/mattjcowan/knex-schema-reader/issues) is the preferred channel
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure
   ...
   git clone https://github.com/<your-username>/knex-schema-reader.git
   # Navigate to the newly cloned directory
   cd knex-schema-reader
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/mattjcowan/knex-schema-reader.git
   ```
